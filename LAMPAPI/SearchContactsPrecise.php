<?php
    ...
    else
    {
        ...
        $stmt = $conn->prepare("SELECT ID, FirstName, LastName, Phone, Email, Address FROM Contacts WHERE (FirstName = ? AND LastName = ? AND Phone = ? AND Email = ? AND Address = ?) AND UserID = ?");
